...
See [dashboard/retail_analytics_dashboard.pdf](dashboard/retail_analytics_dashboard.pdf) for visualizations.
...
1. Run Python data cleaning scripts
2. Execute SQL schema setup
3. Run analytical queries
4. Connect Power BI to PostgreSQL
5. Load dashboard file (.pbix)
